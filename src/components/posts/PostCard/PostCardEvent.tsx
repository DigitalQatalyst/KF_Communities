...
export const PostCardEvent: React.FC<PostCardEventProps> = ({
  ...
  return <div className="space-y-3">
      <div className="flex gap-3">
        {/* Date Badge */}
        {eventDate && <div className="flex-shrink-0 w-16 h-16 bg-blue-50 border-2 border-blue-200 rounded-lg flex flex-col items-center justify-center">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="space-y-1.5">
            {eventDate && <div className="flex items-center gap-1.5 text-sm text-gray-600">
                ...
                {!isPastEvent && <span className="text-xs text-blue-600 font-medium ml-1">
          ...
          {!isPastEvent && <Button size="sm" className="bg-blue-600 hover:bg-blue-700 text-white" onClick={e => e.stopPropagation()}>
              Join Event
            </Button>}
        </div>
      </div>
