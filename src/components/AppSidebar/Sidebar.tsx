...
export const BurgerMenuButton: React.FC<{
  ...
  return <button onClick={onClick} className={`p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-colors ${className}`} aria-label="Open navigation menu">
      <Menu size={20} />
    </button>;
};