...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  return <div className="flex flex-col min-h-[340px] bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 border border-gray-200" onClick={onQuickView} role={onQuickView ? 'button' : undefined} tabIndex={onQuickView ? 0 : undefined} onKeyDown={onQuickView ? e => {
