...
export const UnifiedCard: React.FC<UnifiedCardProps> = ({
  ...
  return <div className={`${getCardClasses()} ${className}`} onClick={onQuickView} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} role={onQuickView ? 'button' : undefined} tabIndex={onQuickView ? 0 : undefined} onKeyDown={onQuickView ? e => {
