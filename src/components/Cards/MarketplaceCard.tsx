...
export const MarketplaceCard: React.FC<MarketplaceCardProps> = ({
  ...
  return <div className="flex flex-col min-h-[340px] bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200 cursor-pointer" onClick={onQuickView} role="button" tabIndex={0} onKeyDown={e => {
